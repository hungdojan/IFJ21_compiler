...
extern frame_stack local_stack; /// Lokalni zasobnik ramcu 
...
/**
 * @brief Prida ukazatel do tabulky symbolu
 *
 * @param stack Ukazatel na zasobnik tabulek symbolu
 ...
 *
 * @details Vyjme nejvrchnejsi tabulku symbolu ze zasobniku a vrati jeji ukazatel uzivateli
 * @param stack Ukazatel na zasobnik tabulek symbolu
...
/**
 * @brief Obnova ukazatele na momentalni scope
 *
 * @details Vraci hodnotu ukazatele momentalniho scope na index nejvrchnejsi tabulky symbolu
 * @param stack Ukazatel na zasobnik tabulek symbolu
 */
 ...
 *
 * @details Snizuje hodnotu indexu v poli tabulek symbolu o jednu nizsi
 * @param stack Ukazatel na zasobnik tabulek symbolu
 */
