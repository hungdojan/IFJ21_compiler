...
/**
 * @brief Vraci zpet prvni token zasobniku
 *
 * @param s Ukazatel na strukturu exp_stack_t
 * @return 
 */
...
/**
 * @brief Vraci zpet prvni vec an zasobniku
 *
 * @param s Ukazatel na strukturu exp_stack_t
 * @return 
 */
...
/**
 * @brief Vraci parametr funkce
 *
 * @param func Cilova funkce
 * @param parm Vkladany parametr
 * @return Chybovy kod
 */
